...
def populate():
    ...
    blogs = [gen_blog_from_txt(users[0], "example-posts/fav-frog.txt"),
             ...
             gen_blog_from_txt(users[0], "example-posts/clutch.txt"),
             gen_blog_from_txt(users[1], "example-posts/enderdragon.txt"),
             gen_blog_from_txt(users[2], "example-posts/top10.txt"),
